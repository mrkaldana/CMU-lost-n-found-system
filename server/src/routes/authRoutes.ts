...
import { adminLogin, login, register, requestPasswordResetOtp, requestRegistrationOtp, resetPasswordWithOtp, updateProfile, verifyPasswordResetOtp } from "../controllers/authController";
